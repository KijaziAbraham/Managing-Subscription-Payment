"""
Django settings for Duxte project.
...
SECRET_KEY = 'django-insecure-m%j9u&0f$1oiu#1e3dhiz(z(dc^vf!e@e8=rll5+6p$wx6tuhx'
...
WSGI_APPLICATION = 'Duxte.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'DuxteSubscriptions',
        'USER': 'kijazi',
        'PASSWORD': 'saraPHIN@12',
        'HOST': 'localhost',
        'PORT': '3306',
